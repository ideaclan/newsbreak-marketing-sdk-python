...
from newsbreak_marketing.adset.schema import AdSetBudgetType, AdSetBidType, AdSetDeliveryRate, Targeting, AdSetOnlineStatus
...
class AdSet(APISession):
    ...
    async def create(self, name:str, budget_type:AdSetBudgetType, budget:int, start_time:int, end_time:int, bid_type:AdSetBidType, bit_rate:int, delivery_rate:AdSetDeliveryRate, targeting:Targeting,optimization:bool = True, tracking_id:str|None = None):
        ...
        data = request('POST', url, self.headers, json=payload)
    ...
    async def delete(self, id:str):
        ...
        data = request('DELETE', url, self.headers)
    ...
    async def get(self,ad_set_id:str):
        ...
        data = request('GET', url, self.headers, params=params)
    ...
    async def update_status(self, status:Status):
        ...
        data = request('PUT', url, self.headers, json=payload)
